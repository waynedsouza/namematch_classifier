...
class Highway(torch.nn.Module):
    ...
    def forward(self, inputs: torch.Tensor) -> torch.Tensor:
        ...
        #print(current_input.shape , "Highway current_input   bSE\n")
        for layer in self._layers:
        ...
        #print(current_input.shape , "Highway POST PROCESS current_input   bSE\n")
...
class CharacterCNN(torch.nn.Module):
    ...
    def forward(self, inputs: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        """
        #print(inputs.shape , "CharacterCNN ENTRY inputs bSE\n")
        # Add BOS/EOS
        mask = ((inputs > 0).long().sum(dim=-1) > 0).long()
        #print(mask.shape , "CharacterCNN MASK  bSE\n")
        ...
        #print(character_embedding.shape , "CharacterCNN character_embedding  bSE\n")
        ...
        #print(character_embedding.shape , "CharacterCNN Transposecharacter_embedding  bSE\n")
        convs = []
        ...
        #print(token_embedding.shape , "CharacterCNN token_embedding  bSE\n")

        # apply the highway layers (batch_size * sequence_length, n_filters)
        token_embedding = self._highways(token_embedding)
        #print(token_embedding.shape , "CharacterCNN token_embeddingPOST _highways  bSE\n")

        # final projection  (batch_size * sequence_length, embedding_dim)
        token_embedding = self._projection(token_embedding)
        #print(token_embedding.shape , "CharacterCNN token_embeddingPOST _projection  bSE\n")
